  ...
  return (
    <Layouts noHeader noFooter>
        ...
        <div className="container">
          <div className="row justify-content-between">
            <div className="col-xl-4">
              ...
              No <span className="mil-accent">events</span> scheduled!
              </h1>
              <p className="mil-light-soft">Stay tuned for future updates and happenings!</p>
            </div>
            <div className="col-xl-6">
              <div className="row align-items-center">
                <div className="col-lg-5">
                  <h4 className="mil-light mil-mb-30">
                    Join The <span className="mil-accent">Flutions</span>
                    <br /> Experience
                  </h4>
                </div>
                <div className="col-lg-7">
                  <p className="mil-light-soft mil-mb-30">
                  Experience innovation. Join Flutions for 
                    <br /> transformative solutions.
                  </p>
                </div>
              </div>
      ...
      <div className="mil-addition-bottom">
        <div className="container-fluid">
          <p className="mil-text-sm mil-light-soft">© Flutions 2023.</p>
